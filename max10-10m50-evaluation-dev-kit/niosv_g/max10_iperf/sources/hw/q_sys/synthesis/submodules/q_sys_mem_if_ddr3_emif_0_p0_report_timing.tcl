...
set tDCD 0.02
	...
	foreach opc $opcs {
		...
		q_sys_mem_if_ddr3_emif_0_p0_perform_flexible_write_launch_timing_analysis $opcs $opcname $inst $family scale_factors $interface_type $max_package_skew $period pins t summary MP IP board

		#######################################
		# Read Analysis

		q_sys_mem_if_ddr3_emif_0_p0_perform_flexible_read_capture_non_dqs_timing_analysis $opcs $opcname $inst $family $period $all_dq_pins pins t summary MP IP board
		...
		q_sys_mem_if_ddr3_emif_0_p0_perform_flexible_bus_turnaround_time_analysis $opcs $opcname $inst $family $period $interface_type $tJITper $tDCD $pll_steps pins t summary MP IP SSN board ISI
