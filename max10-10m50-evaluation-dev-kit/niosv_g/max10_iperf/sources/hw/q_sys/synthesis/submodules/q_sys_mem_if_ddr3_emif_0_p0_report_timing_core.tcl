...
#############################################################
proc q_sys_mem_if_ddr3_emif_0_p0_perform_flexible_write_launch_timing_analysis {opcs opcname inst family scale_factors_name interface_type max_package_skew period pin_array_name timing_parameters_array_name summary_name MP_name IP_name board_name} {
...
proc q_sys_mem_if_ddr3_emif_0_p0_perform_ac_analyses {opcs opcname inst scale_factors_name pin_array_name timing_parameters_array_name summary_name IP_name} {
	...
	foreach ck_pin $pins(ck_pins) {
		set clk_clk_phase_select_node [q_sys_mem_if_ddr3_emif_0_p0_traverse_to_ddio_out_periphery_clock $ck_pin msg_list]
	...
	foreach ac_pin $ac_pins {
		...
		set ac_clk_phase_select_node [q_sys_mem_if_ddr3_emif_0_p0_traverse_to_ddio_out_periphery_clock $ac_pin msg_list]
		...
		set extra_ccpr [q_sys_mem_if_ddr3_emif_0_p0_round_3dp [expr ($clk_max - $clk_min + $ac_max - $ac_min)/2.0]]
		...
		set ACperiphery_min_delay [expr [q_sys_mem_if_ddr3_emif_0_p0_min_in_collection $ACperiphery_min "arrival_time"] + [q_sys_mem_if_ddr3_emif_0_p0_min_in_collection $ACperiphery_min2 "arrival_time"]]
		set ACperiphery_max_delay [expr [q_sys_mem_if_ddr3_emif_0_p0_max_in_collection $ACperiphery_max "arrival_time"] + [q_sys_mem_if_ddr3_emif_0_p0_min_in_collection $ACperiphery_max2 "arrival_time"]]
		set aiot_delay [q_sys_mem_if_ddr3_emif_0_p0_round_3dp [expr [q_sys_mem_if_ddr3_emif_0_p0_get_rise_aiot_delay $ac_pin] * 1e9]]
	...
	lappend ac_summary [list "  Extra common clock pessimism removal" [q_sys_mem_if_ddr3_emif_0_p0_format_3dp [expr $setup_slack - $default_setup_slack]] [q_sys_mem_if_ddr3_emif_0_p0_format_3dp [expr $hold_slack - $default_hold_slack]]]
	...
	foreach dqs_pin $pins(dqs_pins) {
		...
		set dqs_clk_phase_select_node [q_sys_mem_if_ddr3_emif_0_p0_traverse_to_ddio_out_periphery_clock $dqs_pin msg_list]
...
proc q_sys_mem_if_ddr3_emif_0_p0_perform_flexible_write_levelling_timing_analysis {opcs opcname instname family period dll_length interface_type tJITper tJITdty tDCD pll_steps pin_array_name timing_parameters_array_name summary_name  MP_name IP_name SSN_name board_name ISI_parameters_name} {
	...
	set dqs_launch_time [q_sys_mem_if_ddr3_emif_0_p0_max_in_collection $data_hold "latch_time"]
	set clk_launch_time [q_sys_mem_if_ddr3_emif_0_p0_min_in_collection $ac_setup "latch_time"]
	...
	set clk_min [q_sys_mem_if_ddr3_emif_0_p0_min_in_collection [get_path -from $pins(pll_ck_clock) -to $pins(ck_pins) -min_path] "arrival_time"]

	# Get the max DQS delay
	set dqs_max [q_sys_mem_if_ddr3_emif_0_p0_max_in_collection [get_path -from $pins(pll_write_clock)  -to $pins(dqs_pins)] "arrival_time"]
	...
	# Get the min CLK delay
	set clk_max [q_sys_mem_if_ddr3_emif_0_p0_max_in_collection [get_path -from $pins(pll_ck_clock) -to $pins(ck_pins)] "arrival_time"]

	set dqs_min [q_sys_mem_if_ddr3_emif_0_p0_min_in_collection [get_path -from $pins(pll_write_clock) -to $pins(dqs_pins) -min_path] "arrival_time"]
...
proc q_sys_mem_if_ddr3_emif_0_p0_perform_flexible_bus_turnaround_time_analysis {opcs opcname instname family period interface_type tJITper tDCD pll_steps pin_array_name timing_parameters_array_name summary_name  MP_name IP_name SSN_name board_name ISI_parameters_name} {
...
proc q_sys_mem_if_ddr3_emif_0_p0_perform_resync_timing_analysis {opcs opcname inst fbasename family scale_factors_name io_std interface_type period pin_array_name timing_parameters_array_name summary_name MP_name IP_name board_name fpga_name SSN_name} {
	...
	set max_dqs_common_to_fifo [q_sys_mem_if_ddr3_emif_0_p0_max_in_collection [get_path -from $dqs_pins -to $fifo_in -nworst 1] "arrival_time"]
...
proc q_sys_mem_if_ddr3_emif_0_p0_perform_flexible_postamble_timing_analysis {opcs opcname instname scale_factors_name family period dll_length interface_type tJITper tJITdty tDCD DQSpathjitter pin_array_name timing_parameters_array_name summary_name  MP_name IP_name SSN_name board_name ISI_parameters_name} {
	...
	set mem_clock_delay_max [q_sys_mem_if_ddr3_emif_0_p0_max_in_collection [get_path -rise_from $pins(pll_write_clock) -fall_to $pins(ck_pins)] "arrival_time"]
	set mem_clock_delay_min [q_sys_mem_if_ddr3_emif_0_p0_min_in_collection [get_path -rise_from $pins(pll_write_clock) -fall_to $pins(ck_pins) -min_path] "arrival_time"]
	set dqs_delay_max  [q_sys_mem_if_ddr3_emif_0_p0_max_in_collection [get_path -rise_from $pins(dqs_pins) -rise_to [get_pins -compatibility_mode *dq_ddio[*].ubidir_dq_dqs|*|dqs_delay_chain|dqsin]] "arrival_time"]
	set dqs_delay_min  [q_sys_mem_if_ddr3_emif_0_p0_min_in_collection [get_path -rise_from $pins(dqs_pins) -rise_to [get_pins -compatibility_mode *dq_ddio[*].ubidir_dq_dqs|*|dqs_delay_chain|dqsin] -min_path] "arrival_time"]	
	...
	set clock_delay_max [q_sys_mem_if_ddr3_emif_0_p0_max_in_collection [get_path -rise_from [list $pins(pll_write_clock) $pins(pll_c2p_write_clock)] -rise_to $dqsenableextend_regs] "arrival_time"]
	set clock_delay_min [q_sys_mem_if_ddr3_emif_0_p0_min_in_collection [get_path -rise_from [list $pins(pll_write_clock) $pins(pll_c2p_write_clock)] -rise_to $dqsenableextend_regs -min_path] "arrival_time"]
...
proc q_sys_mem_if_ddr3_emif_0_p0_perform_flexible_read_capture_non_dqs_timing_analysis {opcs opcname inst family period all_dq_pins pin_array_name timing_parameters_array_name summary_name MP_name IP_name board_name} {
	...
	set DQ_max [expr [q_sys_mem_if_ddr3_emif_0_p0_max_in_collection $DQ_paths_setup "arrival_time"] - [q_sys_mem_if_ddr3_emif_0_p0_max_in_collection $DQ_paths_setup "launch_time"] - [q_sys_mem_if_ddr3_emif_0_p0_min_in_collection $DQ_paths_setup "required_time"] + [q_sys_mem_if_ddr3_emif_0_p0_min_in_collection $DQ_paths_setup "latch_time"]]
	set DQ_min [expr [q_sys_mem_if_ddr3_emif_0_p0_min_in_collection $DQ_paths_hold  "arrival_time"] - [q_sys_mem_if_ddr3_emif_0_p0_min_in_collection $DQ_paths_hold  "launch_time"] - [q_sys_mem_if_ddr3_emif_0_p0_max_in_collection $DQ_paths_hold "required_time"]  + [q_sys_mem_if_ddr3_emif_0_p0_max_in_collection $DQ_paths_hold  "latch_time"]]
	...
	set clock_max [q_sys_mem_if_ddr3_emif_0_p0_max_in_collection $clock_max_paths "arrival_time"]
	set clock_min [q_sys_mem_if_ddr3_emif_0_p0_min_in_collection $clock_min_paths "arrival_time"]
	...
	set fcolour [q_sys_mem_if_ddr3_emif_0_p0_get_colours $setup_slack $hold_slack]
	lappend rc_summary [list "  Ideal Read Capture" [q_sys_mem_if_ddr3_emif_0_p0_format_3dp [expr $period/4]] [q_sys_mem_if_ddr3_emif_0_p0_format_3dp [expr $period/4]]] 
	lappend rc_summary [list "  MinMax DQ variation" [q_sys_mem_if_ddr3_emif_0_p0_format_3dp [expr 0-$minmax_DQ_variation/2]] [q_sys_mem_if_ddr3_emif_0_p0_format_3dp [expr 0-$minmax_DQ_variation/2]]] 
	lappend rc_summary [list "  MinMax clock variation" [q_sys_mem_if_ddr3_emif_0_p0_format_3dp [expr 0-$minmax_clock_variation/2]] [q_sys_mem_if_ddr3_emif_0_p0_format_3dp [expr 0-$minmax_clock_variation/2]]] 
	lappend rc_summary [list "  Memory uncertainty" [q_sys_mem_if_ddr3_emif_0_p0_format_3dp [expr 0-$tAC]] [q_sys_mem_if_ddr3_emif_0_p0_format_3dp [expr 0-$tAC]]] 
	lappend rc_summary [list "  PLL Quantization error" [q_sys_mem_if_ddr3_emif_0_p0_format_3dp [expr 0-$phy_uncertainty]] [q_sys_mem_if_ddr3_emif_0_p0_format_3dp [expr 0-$phy_uncertainty]]]
	lappend rc_summary [list "  Calibration uncertainty" [q_sys_mem_if_ddr3_emif_0_p0_format_3dp [expr 0-$calibration_uncertainty]] [q_sys_mem_if_ddr3_emif_0_p0_format_3dp [expr 0-$calibration_uncertainty]]]
	lappend rc_summary [list "  DCD" [q_sys_mem_if_ddr3_emif_0_p0_format_3dp [expr 0-$tDCD_time]] [q_sys_mem_if_ddr3_emif_0_p0_format_3dp [expr 0-$tDCD_time]]] 
	lappend rc_summary [list "  Jitters" [q_sys_mem_if_ddr3_emif_0_p0_format_3dp [expr 0-$total_setup_jitter]] [q_sys_mem_if_ddr3_emif_0_p0_format_3dp [expr 0-$total_hold_jitter]]] 
	lappend rc_summary [list "  SSN Effect" [q_sys_mem_if_ddr3_emif_0_p0_format_3dp [expr 0-$total_ssi/2]] [q_sys_mem_if_ddr3_emif_0_p0_format_3dp [expr 0-$total_ssi/2 ]]] 
	lappend rc_summary [list "  Board Skew" [q_sys_mem_if_ddr3_emif_0_p0_format_3dp [expr 0-$board(intra_DQS_group_skew)/2]] [q_sys_mem_if_ddr3_emif_0_p0_format_3dp [expr 0-$board(intra_DQS_group_skew)/2]]] 
