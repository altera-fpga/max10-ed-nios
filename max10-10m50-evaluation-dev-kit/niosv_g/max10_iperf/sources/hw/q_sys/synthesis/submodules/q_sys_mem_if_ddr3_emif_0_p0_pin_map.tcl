...
proc q_sys_mem_if_ddr3_emif_0_p0_get_input_clk_id { pll_output_node_id } {
	if {[q_sys_mem_if_ddr3_emif_0_p0_is_node_type_pll_clk $pll_output_node_id]} {
		...
		q_sys_mem_if_ddr3_emif_0_p0_traverse_fanin_up_to_depth $pll_output_node_id q_sys_mem_if_ddr3_emif_0_p0_is_node_type_pll_inclk clock results_array 1
		if {[array size results_array] == 1} {
			...
			q_sys_mem_if_ddr3_emif_0_p0_traverse_fanin_up_to_depth $pll_inclk_id q_sys_mem_if_ddr3_emif_0_p0_is_node_type_pin clock results_array 3
			if {[array size results_array] == 1} {
				...
				if {[array size pll_clk_results_array] == 1} {
					...
					q_sys_mem_if_ddr3_emif_0_p0_traverse_fanin_up_to_depth $pll_inclk_id q_sys_mem_if_ddr3_emif_0_p0_is_node_type_pin clock results_array 20
					if {[array size results_array] == 1} {
						set pin_id [lindex [array names results_array] 0]
						set result $pin_id
					} else {
...
proc q_sys_mem_if_ddr3_emif_0_p0_get_output_clock_id { ddio_output_pin_list pin_type msg_list_name {max_search_depth 13} } {
...
proc q_sys_mem_if_ddr3_emif_0_p0_get_output_clock_clkbuf_id { ddio_output_pin_list pin_type msg_list_name {max_search_depth 13} } {
	upvar 1 $msg_list_name msg_list
	set output_clock_id -1
...
proc q_sys_mem_if_ddr3_emif_0_p0_get_acv_read_offset { period dqs_phase dqs_period } {
...
proc q_sys_mem_if_ddr3_emif_0_p0_gcd {p q} {
	set p [expr {abs($p)}]
	set q [expr {abs($q)}]
	while {$q != 0} {
		set r [expr {$p % $q}]
...
proc q_sys_mem_if_ddr3_emif_0_p0_traverse_to_ddio_out_periphery_clock {pin msg_list_name} {
	upvar 1 $msg_list_name msg_list
	set result ""
	if {$pin != ""} {
...
proc q_sys_mem_if_ddr3_emif_0_p0_get_dqs_phase_setting { dqs_pins } {
...
proc q_sys_mem_if_ddr3_emif_0_p0_get_dqs_phase { dqs_pins } {
	...
	set dll_length 8
	set dqs_phase_setting [ q_sys_mem_if_ddr3_emif_0_p0_get_dqs_phase_setting $dqs_pins ]

	if { $dqs_phase_setting != $::GLOBAL_q_sys_mem_if_ddr3_emif_0_p0_dqs_delay_chain_length } {
		...
		post_message -type critical_warning "   Parameter value: $::GLOBAL_q_sys_mem_if_ddr3_emif_0_p0_dqs_delay_chain_length"
...
proc q_sys_mem_if_ddr3_emif_0_p0_get_ddr_pins { instname allpins } {
	...
	if {$pll_ref_clock_id == -1} {
		post_message -type error "q_sys_mem_if_ddr3_emif_0_p0_pin_map.tcl: Failed to find PLL reference clock"
	} else {
...
proc q_sys_mem_if_ddr3_emif_0_p0_dump_static_pin_map { ddr_db_par filename } {
	...
	foreach instname $instnames {
		...
		q_sys_mem_if_ddr3_emif_0_p0_static_map_expand_string $FH pins valid_fifo_wrdata_reg 
		q_sys_mem_if_ddr3_emif_0_p0_static_map_expand_string $FH pins valid_fifo_rddata_reg
