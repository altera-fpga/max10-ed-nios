...
catch { eval [concat [list exec "/p/psg/swip/releases/acdskit/25.1std/1129/linux64/quartus/sopc_builder/bin/ip-generate" --component-name=qsys_sequencer_110] $arg_list] } temp
puts $temp
