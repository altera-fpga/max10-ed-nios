# Nios® V/g Simple Socket Server (SSS) Design

 Simple Socket Server design on MAX® 10 FPGA 10M50 Evaluation Kit DK-DEV-10M50F484-B
...
## Description
 ...
 ![image](https://github.com/altera-fpga/max10-ed-nios/blob/rel/25.1std/max10-10m50-evaluation-dev-kit/niosv_g/max10_sss/img/max10_sss.png)
 
## Project Details

- **Title**: Nios® V/g Simple Socket Server Design
- **Source**: Github
- **Design Support**: CTH
- **Family**: Max 10
...
- **Design Package**: max10_sss.zip
- **Category**: Networking
- **URL**: https://github.com/altera-fpga/max10-ed-nios/blob/rel/25.1std/max10-10m50-evaluation-dev-kit/niosv_g/max10_sss
- **download URL**: max10_sss.zip

## Documentation

- **Title**: Design Document
- **URL**:https://github.com/altera-fpga/max10-ed-nios/blob/rel/25.1std/max10-10m50-evaluation-dev-kit/niosv_g/max10_sss/docs/niosv_g_processor_sss_design_on_max10_FPGA.md
...
#### Binaries
 - Prebuilt binaries are located [here](https://github.com/altera-fpga/max10-ed-nios/blob/rel/25.1std/max10-10m50-evaluation-dev-kit/niosv_g/max10_sss/ready_to_test).
...
niosv-app --bsp-dir=software/bsp --app-dir=software/app_sss --incs=software/app_sss --srcs=software/app_sss/alt_error_handler.c,software/app_sss/led.c,software/app_sss/main.c,software/app_sss/simple_socket_server.c,software/app_sss/uc_tcp_ip_init.c
cmake -S software/app_sss -B software/app_sss/build -G 'Unix Makefiles' -DCMAKE_BUILD_TYPE=Debug
make -j4 -C software/app_sss/build
```   
...
```
niosv-download -g -r ready_to_test/app_sss.elf -c 1
```

For the simple socket server application, the board has a simple LED toggling application. Run telnet application on the link partner.
```
telnet <ip_address_of_board> <port number>
```
