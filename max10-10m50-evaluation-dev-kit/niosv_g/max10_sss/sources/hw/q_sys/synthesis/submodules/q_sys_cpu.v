...
module q_sys_cpu (
	...
	q_sys_cpu_hart #(
		...
		.DBG_EXPN_VECTOR          (32'b10000000000000000000000000000000),
		...
		.PERIPHERAL_REGION_A_BASE (32'b10000000000000000000000000000000),
		.PERIPHERAL_REGION_B_SIZE (0),
		.PERIPHERAL_REGION_B_BASE (32'b00000000000000000000000000000000),
		.DBG_DATA_S_BASE          (32'b10000000000000000000000000000000),
		.TIMER_MSIP_DATA_S_BASE   (32'b00001100000000010001000100000000),
		.DTCM1_SIZE               (0),
	...
	q_sys_cpu_irq_mapper irq_mapper (
		.clk           (clk),                      //       clk.clk
	...
	q_sys_cpu_irq_mapper irq_mapper_001 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset
	...
	q_sys_cpu_irq_mapper irq_mapper_002 (
		.clk           (clk),                          //       clk.clk
		.reset         (reset_reset),                  // clk_reset.reset
