...
(
    ...
    // -------------------------------------------------------
    localparam PAD0 = log2ceil(64'hd000400 - 64'hd000000); 
    localparam PAD1 = log2ceil(64'hd012000 - 64'hd010000); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'hd012000;
    ...
    // ( 0xd000000 .. 0xd000400 )
    if ( {address[RG:PAD0],{PAD0{1'b0}}} == 28'hd000000   ) begin
            src_channel = 17'b01;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 3;
    end

    // ( 0xd010000 .. 0xd012000 )
    if ( {address[RG:PAD1],{PAD1{1'b0}}} == 28'hd010000   ) begin
            src_channel = 17'b10;
