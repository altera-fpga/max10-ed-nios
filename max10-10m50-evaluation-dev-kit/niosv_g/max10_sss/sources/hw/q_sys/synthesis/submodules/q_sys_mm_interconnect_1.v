...
// 
// Generated using ACDS version 24.1 1057
...
module q_sys_mm_interconnect_1 (
		...
		input  wire [31:0] msgdma_rx_descriptor_read_master_address,             //        msgdma_rx_descriptor_read_master.address
		...
		input  wire [31:0] msgdma_rx_descriptor_write_master_address,            //       msgdma_rx_descriptor_write_master.address
		...
		input  wire [31:0] msgdma_tx_descriptor_read_master_address,             //        msgdma_tx_descriptor_read_master.address
		...
		input  wire [31:0] msgdma_tx_descriptor_write_master_address,            //       msgdma_tx_descriptor_write_master.address
		...
		output wire [10:0] descr_mem_s1_address,                                 //                            descr_mem_s1.address
		output wire        descr_mem_s1_write,                                   //                                        .write
		input  wire [31:0] descr_mem_s1_readdata,                                //                                        .readdata
		output wire [31:0] descr_mem_s1_writedata,                               //                                        .writedata
		output wire [3:0]  descr_mem_s1_byteenable,                              //                                        .byteenable
		output wire        descr_mem_s1_chipselect,                              //                                        .chipselect
		output wire        descr_mem_s1_clken                                    //                                        .clken
	);
	...
	wire   [31:0] msgdma_rx_descriptor_read_master_translator_avalon_universal_master_0_address;             // msgdma_rx_descriptor_read_master_translator:uav_address -> msgdma_rx_descriptor_read_master_agent:av_address
	...
	wire  [103:0] rsp_mux_src_data;                                                                          // rsp_mux:src_data -> msgdma_rx_descriptor_read_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                                         // msgdma_rx_descriptor_read_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [3:0] rsp_mux_src_channel;                                                                       // rsp_mux:src_channel -> msgdma_rx_descriptor_read_master_agent:rp_channel
	...
	wire   [31:0] msgdma_tx_descriptor_read_master_translator_avalon_universal_master_0_address;             // msgdma_tx_descriptor_read_master_translator:uav_address -> msgdma_tx_descriptor_read_master_agent:av_address
	...
	wire  [103:0] rsp_mux_001_src_data;                                                                      // rsp_mux_001:src_data -> msgdma_tx_descriptor_read_master_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                                     // msgdma_tx_descriptor_read_master_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [3:0] rsp_mux_001_src_channel;                                                                   // rsp_mux_001:src_channel -> msgdma_tx_descriptor_read_master_agent:rp_channel
	...
	wire   [31:0] msgdma_rx_descriptor_write_master_translator_avalon_universal_master_0_address;            // msgdma_rx_descriptor_write_master_translator:uav_address -> msgdma_rx_descriptor_write_master_agent:av_address
	...
	wire  [103:0] rsp_mux_002_src_data;                                                                      // rsp_mux_002:src_data -> msgdma_rx_descriptor_write_master_agent:rp_data
	wire          rsp_mux_002_src_ready;                                                                     // msgdma_rx_descriptor_write_master_agent:rp_ready -> rsp_mux_002:src_ready
	wire    [3:0] rsp_mux_002_src_channel;                                                                   // rsp_mux_002:src_channel -> msgdma_rx_descriptor_write_master_agent:rp_channel
	...
	wire   [31:0] msgdma_tx_descriptor_write_master_translator_avalon_universal_master_0_address;            // msgdma_tx_descriptor_write_master_translator:uav_address -> msgdma_tx_descriptor_write_master_agent:av_address
	...
	wire  [103:0] rsp_mux_003_src_data;                                                                      // rsp_mux_003:src_data -> msgdma_tx_descriptor_write_master_agent:rp_data
	wire          rsp_mux_003_src_ready;                                                                     // msgdma_tx_descriptor_write_master_agent:rp_ready -> rsp_mux_003:src_ready
	wire    [3:0] rsp_mux_003_src_channel;                                                                   // rsp_mux_003:src_channel -> msgdma_tx_descriptor_write_master_agent:rp_channel
	...
	wire   [31:0] descr_mem_s1_agent_m0_readdata;                                                            // descr_mem_s1_translator:uav_readdata -> descr_mem_s1_agent:m0_readdata
	wire          descr_mem_s1_agent_m0_waitrequest;                                                         // descr_mem_s1_translator:uav_waitrequest -> descr_mem_s1_agent:m0_waitrequest
	wire          descr_mem_s1_agent_m0_debugaccess;                                                         // descr_mem_s1_agent:m0_debugaccess -> descr_mem_s1_translator:uav_debugaccess
	wire   [31:0] descr_mem_s1_agent_m0_address;                                                             // descr_mem_s1_agent:m0_address -> descr_mem_s1_translator:uav_address
	wire    [3:0] descr_mem_s1_agent_m0_byteenable;                                                          // descr_mem_s1_agent:m0_byteenable -> descr_mem_s1_translator:uav_byteenable
	wire          descr_mem_s1_agent_m0_read;                                                                // descr_mem_s1_agent:m0_read -> descr_mem_s1_translator:uav_read
	wire          descr_mem_s1_agent_m0_readdatavalid;                                                       // descr_mem_s1_translator:uav_readdatavalid -> descr_mem_s1_agent:m0_readdatavalid
	wire          descr_mem_s1_agent_m0_lock;                                                                // descr_mem_s1_agent:m0_lock -> descr_mem_s1_translator:uav_lock
	wire   [31:0] descr_mem_s1_agent_m0_writedata;                                                           // descr_mem_s1_agent:m0_writedata -> descr_mem_s1_translator:uav_writedata
	wire          descr_mem_s1_agent_m0_write;                                                               // descr_mem_s1_agent:m0_write -> descr_mem_s1_translator:uav_write
	wire    [2:0] descr_mem_s1_agent_m0_burstcount;                                                          // descr_mem_s1_agent:m0_burstcount -> descr_mem_s1_translator:uav_burstcount
	wire          descr_mem_s1_agent_rf_source_valid;                                                        // descr_mem_s1_agent:rf_source_valid -> descr_mem_s1_agent_rsp_fifo:in_valid
	wire  [104:0] descr_mem_s1_agent_rf_source_data;                                                         // descr_mem_s1_agent:rf_source_data -> descr_mem_s1_agent_rsp_fifo:in_data
	wire          descr_mem_s1_agent_rf_source_ready;                                                        // descr_mem_s1_agent_rsp_fifo:in_ready -> descr_mem_s1_agent:rf_source_ready
	wire          descr_mem_s1_agent_rf_source_startofpacket;                                                // descr_mem_s1_agent:rf_source_startofpacket -> descr_mem_s1_agent_rsp_fifo:in_startofpacket
	wire          descr_mem_s1_agent_rf_source_endofpacket;                                                  // descr_mem_s1_agent:rf_source_endofpacket -> descr_mem_s1_agent_rsp_fifo:in_endofpacket
	wire          descr_mem_s1_agent_rsp_fifo_out_valid;                                                     // descr_mem_s1_agent_rsp_fifo:out_valid -> descr_mem_s1_agent:rf_sink_valid
	wire  [104:0] descr_mem_s1_agent_rsp_fifo_out_data;                                                      // descr_mem_s1_agent_rsp_fifo:out_data -> descr_mem_s1_agent:rf_sink_data
	wire          descr_mem_s1_agent_rsp_fifo_out_ready;                                                     // descr_mem_s1_agent:rf_sink_ready -> descr_mem_s1_agent_rsp_fifo:out_ready
	wire          descr_mem_s1_agent_rsp_fifo_out_startofpacket;                                             // descr_mem_s1_agent_rsp_fifo:out_startofpacket -> descr_mem_s1_agent:rf_sink_startofpacket
	wire          descr_mem_s1_agent_rsp_fifo_out_endofpacket;                                               // descr_mem_s1_agent_rsp_fifo:out_endofpacket -> descr_mem_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_src_valid;                                                                         // cmd_mux:src_valid -> descr_mem_s1_agent:cp_valid
	wire  [103:0] cmd_mux_src_data;                                                                          // cmd_mux:src_data -> descr_mem_s1_agent:cp_data
	wire          cmd_mux_src_ready;                                                                         // descr_mem_s1_agent:cp_ready -> cmd_mux:src_ready
	wire    [3:0] cmd_mux_src_channel;                                                                       // cmd_mux:src_channel -> descr_mem_s1_agent:cp_channel
	wire          cmd_mux_src_startofpacket;                                                                 // cmd_mux:src_startofpacket -> descr_mem_s1_agent:cp_startofpacket
	wire          cmd_mux_src_endofpacket;                                                                   // cmd_mux:src_endofpacket -> descr_mem_s1_agent:cp_endofpacket
	wire          msgdma_rx_descriptor_read_master_agent_cp_valid;                                           // msgdma_rx_descriptor_read_master_agent:cp_valid -> router:sink_valid
	wire  [103:0] msgdma_rx_descriptor_read_master_agent_cp_data;                                            // msgdma_rx_descriptor_read_master_agent:cp_data -> router:sink_data
	...
	wire  [103:0] msgdma_tx_descriptor_read_master_agent_cp_data;                                            // msgdma_tx_descriptor_read_master_agent:cp_data -> router_001:sink_data
	...
	wire  [103:0] msgdma_rx_descriptor_write_master_agent_cp_data;                                           // msgdma_rx_descriptor_write_master_agent:cp_data -> router_002:sink_data
	...
	wire  [103:0] msgdma_tx_descriptor_write_master_agent_cp_data;                                           // msgdma_tx_descriptor_write_master_agent:cp_data -> router_003:sink_data
	...
	wire          descr_mem_s1_agent_rp_valid;                                                               // descr_mem_s1_agent:rp_valid -> router_004:sink_valid
	wire  [103:0] descr_mem_s1_agent_rp_data;                                                                // descr_mem_s1_agent:rp_data -> router_004:sink_data
	wire          descr_mem_s1_agent_rp_ready;                                                               // router_004:sink_ready -> descr_mem_s1_agent:rp_ready
	wire          descr_mem_s1_agent_rp_startofpacket;                                                       // descr_mem_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          descr_mem_s1_agent_rp_endofpacket;                                                         // descr_mem_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire          descr_mem_s1_agent_rdata_fifo_src_valid;                                                   // descr_mem_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] descr_mem_s1_agent_rdata_fifo_src_data;                                                    // descr_mem_s1_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire          descr_mem_s1_agent_rdata_fifo_src_ready;                                                   // avalon_st_adapter:in_0_ready -> descr_mem_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_out_0_valid;                                                             // avalon_st_adapter:out_0_valid -> descr_mem_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                                                              // avalon_st_adapter:out_0_data -> descr_mem_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                                             // descr_mem_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                                             // avalon_st_adapter:out_0_error -> descr_mem_s1_agent:rdata_fifo_sink_error
	...
	) descr_mem_s1_translator (
		.clk                    (clk_0_clk_clk),                                 //                      clk.clk
		.reset                  (msgdma_rx_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (descr_mem_s1_agent_m0_address),                 // avalon_universal_slave_0.address
		.uav_burstcount         (descr_mem_s1_agent_m0_burstcount),              //                         .burstcount
		.uav_read               (descr_mem_s1_agent_m0_read),                    //                         .read
		.uav_write              (descr_mem_s1_agent_m0_write),                   //                         .write
		.uav_waitrequest        (descr_mem_s1_agent_m0_waitrequest),             //                         .waitrequest
		.uav_readdatavalid      (descr_mem_s1_agent_m0_readdatavalid),           //                         .readdatavalid
		.uav_byteenable         (descr_mem_s1_agent_m0_byteenable),              //                         .byteenable
		.uav_readdata           (descr_mem_s1_agent_m0_readdata),                //                         .readdata
		.uav_writedata          (descr_mem_s1_agent_m0_writedata),               //                         .writedata
		.uav_lock               (descr_mem_s1_agent_m0_lock),                    //                         .lock
		.uav_debugaccess        (descr_mem_s1_agent_m0_debugaccess),             //                         .debugaccess
		.av_address             (descr_mem_s1_address),                          //      avalon_anti_slave_0.address
		.av_write               (descr_mem_s1_write),                            //                         .write
		.av_readdata            (descr_mem_s1_readdata),                         //                         .readdata
		.av_writedata           (descr_mem_s1_writedata),                        //                         .writedata
		.av_byteenable          (descr_mem_s1_byteenable),                       //                         .byteenable
		.av_chipselect          (descr_mem_s1_chipselect),                       //                         .chipselect
		.av_clken               (descr_mem_s1_clken),                            //                         .clken
		.av_read                (),                                              //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                 //             clk.clk
		.reset                   (msgdma_rx_reset_n_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (descr_mem_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (descr_mem_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (descr_mem_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (descr_mem_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (descr_mem_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (descr_mem_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (descr_mem_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (descr_mem_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (descr_mem_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (descr_mem_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (descr_mem_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (descr_mem_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (descr_mem_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (descr_mem_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (descr_mem_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (descr_mem_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (descr_mem_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (descr_mem_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (descr_mem_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (descr_mem_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (descr_mem_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (descr_mem_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (descr_mem_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (descr_mem_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (descr_mem_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (descr_mem_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                 // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                 //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                  //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                 //                .error
		.rdata_fifo_src_ready    (descr_mem_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (descr_mem_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (descr_mem_s1_agent_rdata_fifo_src_data),        //                .data
	...
	) descr_mem_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                 //       clk.clk
		.reset             (msgdma_rx_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (descr_mem_s1_agent_rf_source_data),             //        in.data
		.in_valid          (descr_mem_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (descr_mem_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (descr_mem_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (descr_mem_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (descr_mem_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (descr_mem_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (descr_mem_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (descr_mem_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (descr_mem_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	q_sys_mm_interconnect_1_router_004 router_004 (
		.sink_ready         (descr_mem_s1_agent_rp_ready),                   //      sink.ready
		.sink_valid         (descr_mem_s1_agent_rp_valid),                   //          .valid
		.sink_data          (descr_mem_s1_agent_rp_data),                    //          .data
		.sink_startofpacket (descr_mem_s1_agent_rp_startofpacket),           //          .startofpacket
		.sink_endofpacket   (descr_mem_s1_agent_rp_endofpacket),             //          .endofpacket
		.clk                (clk_0_clk_clk),                                 //       clk.clk
		.reset              (msgdma_rx_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	q_sys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_0_data      (descr_mem_s1_agent_rdata_fifo_src_data),        //     in_0.data
		.in_0_valid     (descr_mem_s1_agent_rdata_fifo_src_valid),       //         .valid
		.in_0_ready     (descr_mem_s1_agent_rdata_fifo_src_ready),       //         .ready
