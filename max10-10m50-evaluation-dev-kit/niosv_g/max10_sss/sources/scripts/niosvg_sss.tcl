...
# File: niosvg_sss.tcl
# Generated on: Thu Mar  5 21:46:22 2026
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "niosvg_sss"]} {
		puts "Project niosvg_sss is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists niosvg_sss]} {
		project_open -revision niosvg_sss niosvg_sss
	} else {
		project_new -revision niosvg_sss niosvg_sss
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name PROJECT_CREATION_TIME_DATE "12:19:18  OCTOBER 25, 2024"
	...
	set_global_assignment -name USE_SIGNALTAP_FILE niosvg_sss.stp
	...
	set_global_assignment -name SIGNALTAP_FILE niosvg_sss.stp
	set_global_assignment -name QSYS_FILE clkctrl.qsys
	set_global_assignment -name VERILOG_FILE m10_rgmii.v
	set_global_assignment -name VERILOG_FILE niosvg_sss.v
	set_global_assignment -name SDC_FILE niosvg_sss.sdc
	set_global_assignment -name QIP_FILE enet_gtx_clk_ddio.qip
	set_global_assignment -name SIP_FILE enet_gtx_clk_ddio.sip
